...
class StartIpIllegal(unittest.TestCase):
    def setUp(self):
        ...
        self.testcaseinfo = TestCaseInfo(id=19, name="结束IP地址非法时提示信息检查 ")
    ...
    def test_start_ip_illegal(self):
        ...
        try:
            ...
            self.lanpage.set_startip("2")
            self.lanpage.clear_endip()
            self.lanpage.set_endip("255")
            ...
            if self.lanpage.is_startip_errorinfo_displayed():
                ...
                try:
                    self.assertEqual(errorinfo, "地址池结束值错误，请重新输入。")
