...
class GotoLan(unittest.TestCase):
    def setUp(self):

        self.testcaseinfo = TestCaseInfo(id=13, name="是否能顺利跳转到lan页面 ")
    ...
    def test_goto_lan(self):
        ...
        try:
            ...
            try:
                self.assertEqual(expecturl,self.lanpage.getCurrentUrl())
