...
class GotoWan(unittest.TestCase):
    def setUp(self):

        self.testcaseinfo = TestCaseInfo(id=3, name="是否能顺利跳转到wan 界面 ")
    ...
    def test_goto_wvan(self):
        ...
        try:
            ...
            time.sleep(5)
            expecturl="http://192.168.0.1/Network.html"
            try:
                self.assertEqual(expecturl,self.webpage.getCurrentUrl())
