...
from  common.commonconfig import base_url,original_login_password
...
class NoNewPassword(unittest.TestCase):
    def setUp(self):
        ...
        self.testcaseinfo = TestCaseInfo(id=33, name="不输入新密码时的提示信息检查 ")
