...
class NoOriginalPassword(unittest.TestCase):
    def setUp(self):
        ...
        self.testcaseinfo = TestCaseInfo(id=32, name="不输入原密码时的提示信息检查 ")
    def test_no_original_password(self):
        try:
            ...
            if self.setuppage.is_error_info1_displayed():
                errorinfo = self.setuppage.get_error_info1_text()
                try:
