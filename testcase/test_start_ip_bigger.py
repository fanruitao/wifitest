...
class StartIpIllegal(unittest.TestCase):
    def setUp(self):
        ...
        self.testcaseinfo = TestCaseInfo(id=20, name="开始IP地址大于结束IP地址时，提示语检查 ")
    ...
    def test_start_ip_illegal(self):
        ...
        try:
            ...
            self.lanpage.set_startip("234")
            self.lanpage.clear_endip()
            self.lanpage.set_endip("12")
            ...
            if self.lanpage.is_startip_errorinfo_displayed():
                ...
                try:
                    self.assertEqual(errorinfo, "地址池结束值不能小于开始值，请重新输入。")
