...
class BasePage(object):
    ...
    def selectbyvalue(self,element,value):
        select=Select(self.findElement(element))
        select.select_by_value(value)
    def elementdisplay(self,element):
        return element.is_displayed()

    def waituntilinvisible(self,element):
        type=element[0].upper()
        # if type == "ID":
        #     method = By.ID
        # else:
        #     method = By.ID
        ...
        wait.until(EC.invisibility_of_element_located((eval("By."+type),value)))

    def waituntilinvisible2(self, element):
        type = element[0].upper()
        # if type == "ID":
        #     method = By.ID
        # else:
